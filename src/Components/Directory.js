 ...
 function Directory() {
    ...
    return (
        <div className="directory-body">
            ...
            <img src={SearchElipse} className="searchelipse" alt="" />
            <img src={SearchLeg} className="searchleg" alt="" />
            <p className="directory">Directory</p>
            <p className="find-grad">Find graduates with various skills and tracks.  </p>
            {/* the man section */}
            ...
            <form className="skill-check">
               <label for="skill1"> <input type="checkbox" id="skill" name="skill1" value="UI" /> UI</label>
                <label for="skill1"><input type="checkbox" id="skill" name="skill2" value="UX" /> UX</label>
                <label for="skill1"><input type="checkbox" id="skill" name="skill3" value="Figma" /> Figma</label>
                <label for="skill1"><input type="checkbox" id="skill" name="skill4" value="Sketch" /> Sketch</label>
               <label for="skill1"> <input type="checkbox" id="skill" name="skill5" value="Javascript" /> Javascript</label>
               <label for="skill1"> <input type="checkbox" id="skill" name="skill6" value="Mobile" /> Mobile</label>
               <label for="skill1">  <input type="checkbox" id="skill" name="skill7" value="Front" />FrontEnd</label>
               <label for="skill1"> <input type="checkbox" id="skill" name="skill8" value="Back" /> BackEnd</label>
               <br/>
               <label id="experience">Years of Experience 
                   <select id="year">
            ...
            <aside className="scroll-notice">
                <p>SCROLL THROUGH OUR LIST OF QUALIFIED GRADUATES <br/> OR <br/>SORT WITH THE FILTER </p>
            </aside>
            ...
            <section>
                ...
                <div className="category">
                  ...
                  <div id="all-line"></div>
                  <label id="interns">750 Interns <dv id="line"></dv>
                  <select id="relevance">
